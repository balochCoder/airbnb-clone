    ...
    if (step === STEPS.DESCRIPTION) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                ...
                <hr/>
                <Input id="description" label="Description" register={register} errors={errors} disabled={isLoading}
                       required/>
    ...
    if (step === STEPS.PRICE) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                ...
                />
                <Input id="price" label="Price" formatPrice type="number" register={register} errors={errors}
